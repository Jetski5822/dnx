...
namespace Microsoft.Dnx.Runtime.Loader
{
    internal class ProjectAssemblyLoader : IAssemblyLoader
    {
        ...
        private readonly ICompilationSession _compilationEngine;
        ...
        public ProjectAssemblyLoader(FrameworkName framework,
                                     ...
                                     ICompilationSession compilationEngine)
        {
        ...
        public Assembly Load(AssemblyName assemblyName, IAssemblyLoadContext loadContext)
        {
            ...
            return _compilationEngine.CompileAndLoadProject(
                project, 
                new CompilationTarget(project.Name, _framework, _configuration, aspect), 
                loadContext);
        }
    }
}